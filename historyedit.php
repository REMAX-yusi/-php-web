...
$sql = "SELECT * FROM `im_history` ORDER BY `id` asc ";
...
<body>
    ...
    <!-- 主容器 -->
    <div class="container">
        <p style="margin: 30px auto 20px 20px;font-size: 2rem;">上次看到</p>
        <!-- 主视窗 -->
                        ...
                        <div class="col">
                            <div class="card card-item" style="width: 18rem;">
                                ...
                                <div class="info">
                                    ...
                                    <div class="btn">
                                        <a href="./unhistory.php?id=<?php echo $v['id'] ?>" class="del">删除</a>
                                    </div>
                                </div>
                            </div>
                        </div>
