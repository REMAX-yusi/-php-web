...
if (!empty($_POST['username'])) {
    ...
    $sql = "UPDATE `im_user` SET `username`='{$username}',`password`='{$password}',
    `create_time`='{$_SERVER['REQUEST_TIME']}',`sex`='{$usersex}',`mail`='{$usermail}',`QQ`='{$userQQ}' 
    WHERE `id`={$_COOKIE['id']}";
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 bg-white">
                            <div class="form d-flex align-items-center">
                                <div class="content">
                                    <form method="post" action="editmine.php" class="form-validate" id="registerFrom">
                                        ...
                                        <button id="register" type="submit" class="btn btn-primary">确定</button>

                                        <br />
                                        <small>不想修改?</small><a href="login.php" class="signup">&nbsp;返回</a><br />

                                    </form>
                                    <form method="post" action="deleteusr.php" class="form-validate" id="registerFrom">
                                        <button id="delete" type="submit" class="btn btn-primary" style="color: #000000;">删除账户</button>
                                    </form>
